...
describe('ModifyScreenComponent', () => {
  ...
  describe('deleteFileInstruction/deleteFileStimuli', () => {
  ...
  describe('checkFileDurationAndTimeScreen', () => {
